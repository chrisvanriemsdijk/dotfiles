...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/cmp-cmdline"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/gruvbox-material"
  },
  ["lspkind-nvim"] = {
    loaded = true,
  ...
  ["nvim-code-action-menu"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/chris/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["telescope-project.nvim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/telescope-project.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
